...
LOAD DATA INFILE '/var/lib/mysql-files/FET_init_nastavnik.unl'INTO TABLE nastavnikFIELDS TERMINATED BY '#' LINES STARTING BY '\n' TERMINATED BY '#\r';
...
LOAD DATA INFILE '/var/lib/mysql-files/FET_init_rezervacija.unl'INTO TABLE rezervacijaFIELDS TERMINATED BY '#' LINES STARTING BY '\n' TERMINATED BY '#\r';
